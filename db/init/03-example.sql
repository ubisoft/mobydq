...
CREATE ROLE user_group_mobydq;
CREATE ROLE user_group_mobydq_admin;

GRANT user_group_mobydq TO user_group_mobydq_admin;

/*policy for indicator_group*/
CREATE POLICY mobydq_all_group ON
  base.indicator_group
FOR ALL
TO user_group_mobydq
USING (
  user_group = 'user_group_mobydq'
);
...
CREATE POLICY user_group_mobydq_parameter_all ON
  base.parameter
FOR ALL
TO user_group_mobydq
USING (
...
CREATE POLICY user_group_mobydq_data_source_select ON
  base.data_source
FOR SELECT
TO user_group_mobydq
USING (
...
CREATE POLICY mobydq_all_admin ON
  base.data_source
FOR ALL
TO user_group_mobydq_admin
USING (
  user_group = 'user_group_mobydq'
);

/*policy for session*/
CREATE POLICY mobydq_select_group ON
  base.session
FOR SELECT
TO user_group_mobydq
USING (
