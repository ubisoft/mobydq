 ...
 */
export const ListTableRowContent = ({ rowData, rowColumns }) => rowColumns.map((column) => <ListTableCell key={`${rowData.id}_${column}`} contents={_buildCell(rowData[column])}/>, rowData);
